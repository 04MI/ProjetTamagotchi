...
class MainScreen(Screen):
    ...
    def handleJouer(self):
        ...
        #Toplevel(self.game.root)
        self.game.root.after_cancel(self.game.runn)
...
class UiGame(Game):
    ...
    def _run(self):#, mutex):
        ...
        if not self.gameStart:
            ...
            #mutex.release()
            self.update()
        self.runn=self.root.after(int(1 / self.tickrate*1000),self._run)
